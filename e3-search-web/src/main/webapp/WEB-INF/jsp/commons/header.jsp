...
<div id="header">
  <div class="header_inner">
    <div class="logo">
			<a name="sfbest_hp_hp_head_logo" href="http://localhost:8080" class="trackref logoleft">
		</a>
			<div class="logo-text">
    ...
    <div class="search">
      <form action="http://localhost:8082/search.html" id="searchForm" name="query" method="GET">
